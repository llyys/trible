  ...
  render() {
    ...
    return (
      <nav className="navbar navbar-toggleable-md navbar-inverse bg-inverse">
        ...
        <button
          className={`navbar-toggler navbar-toggler-right ${this.state.expanded
            ? ""
            : "collapsed"}`}
          type="button"
        ...
        <div
          className={`navbar-collapse collapse ${this.state.expanded
            ? "show"
            : ""}`}
        ...
        >
          <ul className="navbar-nav mr-auto">
            ...
            <li className="nav-item">
              <Link to="/admin" className="nav-link disabled">
                Disabled
              </Link>
            </li>
            <NavDropDown />
    ...
    return (
      <li className={`nav-item dropdown ${this.state.expanded ? "show" : ""}`}>
        ...
        <div className="dropdown-menu" aria-labelledby="dropdown01">
          <a className="dropdown-item" onClick={this.toggleState} href="#">
            Action
          </a>
          <a className="dropdown-item" onClick={this.toggleState} href="#">
            Another action
